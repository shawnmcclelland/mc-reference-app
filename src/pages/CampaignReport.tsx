              ...
              <div className="flex flex-col gap-2 flex-1">
                ...
                <div className="flex flex-col gap-2">
                  <div className="flex items-center gap-1 pt-2">
                    <span className="text-component-x-small text-[#727E85]">Recipients</span>
                    <span className="text-component-x-small text-mailchimp-text-primary">23,019</span>
                  </div>
                  <div className="flex items-center gap-1 pt-2 border-t border-mailchimp-border-primary">
                    <span className="text-component-x-small text-[#727E85]">Audience</span>
                    <span className="text-component-x-small text-mailchimp-text-primary">Clay Collective</span>
                  </div>
                  <div className="flex items-center gap-1 pt-2 border-t border-mailchimp-border-primary">
                    <span className="text-component-x-small text-[#727E85]">Subject</span>
                    <span className="text-component-x-small text-mailchimp-text-primary">Fired & Formed: Clay Collective Silent Auction</span>
                  </div>
                  <div className="flex items-center gap-1 pt-2 border-t border-mailchimp-border-primary">
                    <span className="text-component-x-small text-[#727E85]">Status</span>
                    <div className="flex items-center gap-1">
                      <div className="flex items-center justify-center px-1.5 py-0.5 rounded-mailchimp bg-[#D2F8D5]">
                        <span className="text-component-x-small text-mailchimp-text-primary">Sent</span>
                      </div>
                      <span className="text-component-x-small text-mailchimp-text-primary">Tue Jan 21, 2025 • 3:53 pm</span>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="flex flex-col items-center h-full rounded-t-lg bg-[#E2E9ED] relative overflow-hidden">
                  <div className="flex flex-col items-center h-full bg-[#6B8395] text-[#F3E8E2] p-4 w-full">
                    ...
                    <div className="px-4 py-1.5 bg-[#F3E8E2] rounded-lg">
                      <span className="text-[6px] text-[#6B8395] font-semibold">Explore member benefits</span>
                    </div>
                ...
                <div className="flex gap-3 px-4 mb-4">
                  <div className="flex-1 flex flex-col gap-2 p-4 rounded-mailchimp bg-mailchimp-active-bg border border-mailchimp-border-primary">
                    ...
                    <div className="flex items-center gap-1">
                      <svg width="10" height="8" viewBox="0 0 10 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M5 4.37114e-07L10 8L0 8L5 4.37114e-07Z" fill="#00892E"/>
                      </svg>
                      <span className="text-component-x-small font-medium text-[#00892E] tracking-[-0.12px]">1%</span>
                    </div>
                  </div>
                  ...
                  <div className="flex-1 flex flex-col gap-2 p-4 border-r border-mailchimp-border-primary bg-mailchimp-background-primary">
                    ...
                    <div className="flex items-center gap-1">
                      ...
                      <span className="text-component-x-small font-medium text-[#00892E] tracking-[-0.12px]">2%</span>
                    </div>
                  </div>
                  ...
                  <div className="flex-1 flex flex-col gap-2 p-4 rounded-mailchimp border border-mailchimp-border-primary bg-mailchimp-background-primary">
                    ...
                    <div className="flex items-center gap-1">
                      <svg width="10" height="8" viewBox="0 0 10 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M5 4.37114e-07L10 8L0 8L5 4.37114e-07Z" fill="#DB334D"/>
                      </svg>
                      <span className="text-component-x-small font-medium text-[#DB334D] tracking-[-0.12px]">1%</span>
                    </div>
                  </div>
                  ...
                  <div className="flex-1 flex flex-col gap-2 p-4 rounded-mailchimp border border-mailchimp-border-primary bg-mailchimp-background-primary">
                    ...
                    <div className="flex items-center gap-1">
                      ...
                      <span className="text-component-x-small font-medium text-[#DB334D] tracking-[-0.12px]">2%</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex">
                  <div className="flex flex-col w-80">
                    <div className="flex items-center h-8 px-3 bg-[#F0F4F6]">
                      <span className="text-component-x-small text-[#727E85]">Segment name</span>
                    </div>
                    <div className="flex items-center h-13 px-3 border-b border-mailchimp-border-primary bg-mailchimp-background-primary">
                      <span className="text-component-small font-medium text-mailchimp-text-primary">www.facebook.com</span>
                    </div>
                    <div className="flex items-center h-13 px-3 border-b border-mailchimp-border-primary bg-[#F8FAFB]">
                      <span className="text-component-small font-medium text-mailchimp-text-primary">https://eventbrite.com/2025-clay-auction</span>
                    </div>
                    <div className="flex items-center h-13 px-3 border-b border-mailchimp-border-primary bg-mailchimp-background-primary">
                      <span className="text-component-small font-medium text-mailchimp-text-primary">https://instagram.com/</span>
                    </div>
                    <div className="flex items-center h-13 px-3 bg-mailchimp-background-primary">
                      <span className="text-component-small font-medium text-mailchimp-text-primary">https://claystudio.com</span>
                    </div>
                  </div>

                  <div className="flex flex-col flex-1">
                    <div className="flex items-center justify-end h-8 px-3 bg-[#F0F4F6]">
                      <span className="text-component-x-small text-[#727E85]">Total clicks</span>
                    </div>
                    <div className="flex items-center justify-end h-13 px-3 border-b border-mailchimp-border-primary bg-mailchimp-background-primary">
                      <span className="text-component-small text-mailchimp-text-primary">332</span>
                    </div>
                    <div className="flex items-center justify-end h-13 px-3 border-b border-mailchimp-border-primary bg-[#F8FAFB]">
                      <span className="text-component-small text-mailchimp-text-primary">286</span>
                    </div>
                    <div className="flex items-center justify-end h-13 px-3 border-b border-mailchimp-border-primary bg-mailchimp-background-primary">
                      <span className="text-component-small text-mailchimp-text-primary">65</span>
                    </div>
                    <div className="flex items-center justify-end h-13 px-3 bg-mailchimp-background-primary">
                      <span className="text-component-small text-mailchimp-text-primary">30</span>
                    </div>
                  </div>

                  <div className="flex flex-col flex-1">
                    <div className="flex items-center justify-end h-8 px-3 bg-[#F0F4F6]">
                      <span className="text-component-x-small text-[#727E85]">Click percentage</span>
                    </div>
                    <div className="flex items-center justify-end h-13 px-3 border-b border-mailchimp-border-primary bg-mailchimp-background-primary">
                      <span className="text-component-small text-mailchimp-text-primary">46.5%</span>
                    </div>
                    <div className="flex items-center justify-end h-13 px-3 border-b border-mailchimp-border-primary bg-[#F8FAFB]">
                      <span className="text-component-small text-mailchimp-text-primary">40.1%</span>
                    </div>
                    <div className="flex items-center justify-end h-13 px-3 border-b border-mailchimp-border-primary bg-mailchimp-background-primary">
                      <span className="text-component-small text-mailchimp-text-primary">9.1%</span>
                    </div>
                    <div className="flex items-center justify-end h-13 px-3 bg-mailchimp-background-primary">
                      <span className="text-component-small text-mailchimp-text-primary">4.3%</span>
                    </div>
                  </div>

                  <div className="flex flex-col flex-1">
                    <div className="flex items-center justify-end h-8 px-3 bg-[#F0F4F6]">
                      <span className="text-component-x-small text-[#727E85]">Unique clicks</span>
                    </div>
                    <div className="flex items-center justify-end h-13 px-3 border-b border-mailchimp-border-primary bg-mailchimp-background-primary">
                      <span className="text-component-small text-mailchimp-text-primary">326</span>
                    </div>
                    <div className="flex items-center justify-end h-13 px-3 border-b border-mailchimp-border-primary bg-[#F8FAFB]">
                      <span className="text-component-small text-mailchimp-text-primary">241</span>
                    </div>
                    <div className="flex items-center justify-end h-13 px-3 border-b border-mailchimp-border-primary bg-mailchimp-background-primary">
                      <span className="text-component-small text-mailchimp-text-primary">48</span>
                    </div>
                    <div className="flex items-center justify-end h-13 px-3 bg-mailchimp-background-primary">
                      <span className="text-component-small text-mailchimp-text-primary">17</span>
                    </div>
                  </div>
                      ...
                      <div className="flex flex-col justify-center items-start gap-0.5 self-stretch">
                          ...
                          <div className="flex min-h-6 items-center gap-1 flex-1">
                            <div className="flex items-start gap-[-1] rounded-full">
                              <div className="flex w-6 h-6 p-1 items-start rounded-full bg-[#F0F4F6]">
                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                  <path d="M8 15C11.866 15 15 11.866 15 8C15 4.13401 11.866 1 8 1C4.13401 1 1 4.13401 1 8C1 11.866 4.13401 15 8 15Z" fill="#F05537"/>
                                  <path d="M7.42445 5.52414C8.47976 5.28963 9.53507 5.71957 10.1213 6.54037L5.45714 7.59568C5.61348 6.59248 6.36913 5.75866 7.42445 5.52414ZM10.1474 9.39361C9.78261 9.92778 9.22238 10.3056 8.58398 10.4489C7.52867 10.6834 6.46033 10.2535 5.87405 9.41967L10.5513 8.36436L11.3069 8.19499L12.7661 7.86928C12.7531 7.55659 12.714 7.24391 12.6489 6.94425C12.0626 4.42975 9.49598 2.85329 6.92936 3.43958C4.36274 4.02586 2.76023 6.52734 3.35955 9.05487C3.95886 11.5824 6.51245 13.1458 9.07907 12.5595C10.5904 12.2208 11.7629 11.2046 12.3623 9.91475L10.1474 9.39361Z" fill="white"/>
                                </svg>
                              </div>
                            </div>
                            <div className="flex flex-col justify-center items-start gap-0.5">
                              <span className="text-[#4C555B] text-component-x-small font-normal leading-4 underline decoration-dotted decoration-[#ADBAC2] underline-offset-[3px]">Purchased from email</span>
                            </div>
                          </div>
                        </div>
                        <div className="flex items-center gap-2 self-stretch">
                          <div className="flex min-w-[120px] flex-col justify-center items-start gap-1">
                            <div className="flex items-center gap-1">
                              <span className="text-mailchimp-text-primary text-[24px] font-medium leading-8 tracking-[-0.48px]">121</span>
                            </div>
                            <div className="flex items-start">
                              <span className="text-mailchimp-text-primary text-component-x-small font-normal leading-4">168 total purchased</span>
                            </div>
                          </div>
                        </div>
                      </div>
                            ...
                            <div className="flex items-start gap-[-1] rounded-full">
                              <div className="flex w-6 h-6 p-1 items-start rounded-full bg-[#F0F4F6]">
                                <svg width="17" height="16" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                  <path d="M8.5 15C12.366 15 15.5 11.866 15.5 8C15.5 4.13401 12.366 1 8.5 1C4.63401 1 1.5 4.13401 1.5 8C1.5 11.866 4.63401 15 8.5 15Z" fill="#F05537"/>
                                  <path d="M7.92445 5.52414C8.97976 5.28963 10.0351 5.71957 10.6213 6.54037L5.95714 7.59568C6.11348 6.59248 6.86913 5.75866 7.92445 5.52414ZM10.6474 9.39361C10.2826 9.92778 9.72238 10.3056 9.08398 10.4489C8.02867 10.6834 6.96033 10.2535 6.37405 9.41967L11.0513 8.36436L11.8069 8.19499L13.2661 7.86928C13.2531 7.55659 13.214 7.24391 13.1489 6.94425C12.5626 4.42975 9.99598 2.85329 7.42936 3.43958C4.86274 4.02586 3.26023 6.52734 3.85955 9.05487C4.45886 11.5824 7.01245 13.1458 9.57907 12.5595C11.0904 12.2208 12.2629 11.2046 12.8623 9.91475L10.6474 9.39361Z" fill="white"/>
                                </svg>
                              </div>
                            </div>
                            <div className="flex flex-col justify-center items-start gap-0.5">
                              <span className="text-[#4C555B] text-component-x-small font-normal leading-4 underline decoration-dotted decoration-[#ADBAC2] underline-offset-[3px]">Revenue from email</span>
                            </div>
                          </div>
                        </div>
                        <div className="flex items-center gap-2 self-stretch">
                          <div className="flex min-w-[120px] flex-col justify-center items-start gap-1">
                            <div className="flex items-center gap-1">
                              <span className="text-mailchimp-text-primary text-[24px] font-medium leading-8 tracking-[-0.48px]">$3,630</span>
                            </div>
                            <div className="flex items-start">
                              <span className="text-mailchimp-text-primary text-component-x-small font-normal leading-4">$5,040 total revenue</span>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="flex flex-col justify-center items-start gap-0.5 self-stretch">
                        <div className="flex min-w-[146px] justify-between items-start self-stretch">
                          <div className="flex min-h-6 items-center gap-1 flex-1">
                            ...
                            <div className="flex flex-col justify-center items-start gap-0.5">
                              <span className="text-[#4C555B] text-component-x-small font-normal leading-4 underline decoration-dotted decoration-[#ADBAC2] underline-offset-[3px]">Page views from email</span>
                            </div>
                          </div>
                        </div>
                        <div className="flex items-center gap-2 self-stretch">
                          <div className="flex min-w-[120px] flex-col justify-center items-start gap-1">
                            <div className="flex items-center gap-1">
                              <span className="text-mailchimp-text-primary text-[24px] font-medium leading-8 tracking-[-0.48px]">241</span>
                            </div>
                            <div className="flex items-start">
                              <span className="text-mailchimp-text-primary text-component-x-small font-normal leading-4">306 total page views</span>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="flex flex-col justify-center items-start gap-0.5 self-stretch">
                        <div className="flex min-w-[146px] justify-between items-start self-stretch">
                          <div className="flex min-h-6 items-center gap-1 flex-1">
                            ...
                            <div className="flex flex-col justify-center items-start gap-0.5">
                              <span className="text-[#4C555B] text-component-x-small font-normal leading-4 underline decoration-dotted decoration-[#ADBAC2] underline-offset-[3px]">Remaining tickets</span>
                            </div>
                          </div>
                        </div>
                        <div className="flex items-center gap-2 self-stretch">
                          <div className="flex min-w-[120px] flex-col justify-center items-start gap-1">
                            <div className="flex items-center gap-1">
                              <span className="text-mailchimp-text-primary text-[24px] font-medium leading-8 tracking-[-0.48px]">132</span>
                            </div>
                            <div className="flex items-start">
                              <span className="text-mailchimp-text-primary text-component-x-small font-normal leading-4">300 total tickets</span>
                            </div>
                          </div>
                        </div>
                      </div>
                  ...
                  <div className="flex flex-col items-start gap-2 self-stretch">
                    <div className="flex justify-between items-center content-center gap-1 self-stretch flex-wrap">
                      <div className="flex items-center gap-1">
                        ...
                        <div className="flex pt-0.5 justify-center items-center gap-2 self-stretch">
                          <span className="text-[#ADBAC2] text-component-x-small font-normal leading-4">Customized automation</span>
                        </div>
                      </div>
                    </div>
                    <div className="flex flex-col items-start gap-1 self-stretch">
                      ...
                      <p className="self-stretch text-[#D5DEE3] text-base font-normal leading-6 overflow-hidden line-clamp-7">
                        People who browse your creations will be more likely to go to the auction. Automatically send browsers an email for better attendance.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-center gap-2 self-stretch">
                    <button className="flex min-w-12 px-2.5 py-1 justify-center items-center gap-1 rounded-mailchimp border border-[#D5DEE3] bg-white">
                      <span className="text-mailchimp-text-primary text-component-x-small font-normal leading-4">Apply automation</span>
                    </button>
                  </div>
                </div>
              </div>
            ...
            <div className="flex gap-6">
              ...
              <div className="w-[830px] min-h-[140px] p-6 flex flex-col gap-4 rounded-mailchimp border border-mailchimp-border-primary bg-white">
                <div className="flex flex-col gap-1">
                      ...
                      <div className="flex items-start">
                        <div className="flex p-0.5 items-center gap-0.5 rounded-mailchimp bg-[#F0F4F6]">
                          <div className="flex min-w-12 px-2.5 py-0.5 justify-center items-center gap-1 rounded bg-white shadow-[0px_1px_4px_0px_rgba(76,85,91,0.2)]">
                            <span className="flex-1 text-mailchimp-text-primary text-center text-component-x-small font-normal leading-4">Opens</span>
                          </div>
                          <div className="flex min-w-12 px-2.5 py-0.5 justify-center items-center gap-1 rounded">
                            <span className="flex-1 text-[#727E85] text-center text-component-x-small font-normal leading-4">Clicks</span>
                          </div>
                          <div className="flex min-w-12 px-2.5 py-0.5 justify-center items-center gap-1 rounded">
                            <span className="flex-1 text-[#727E85] text-center text-component-x-small font-normal leading-4">Recipients</span>
                          </div>
                        </div>
                      </div>
                  ...
                  <div className="flex max-w-[600px] pr-15 justify-center items-center gap-2.5 self-stretch">
                    <p className="flex-1 text-[#4C555B] text-component-x-small font-normal leading-4">
                      Based on user interests and behavior data science predicts age and gender of contacts to identify key characteristics of your audience.
                    </p>
                  </div>
                </div>
                <div className="flex flex-col items-start gap-4 self-stretch">
                  <div className="flex items-start gap-6 self-stretch">
                    ...
                    <div className="flex flex-col items-start gap-2 flex-1">
                      <h3 className="text-component-small font-medium text-mailchimp-text-primary leading-[140%] tracking-[-0.14px] self-stretch">Gender</h3>
                      <div className="flex h-[168px] items-center gap-4 self-stretch">
                        <svg className="w-[150px] h-[150px] aspect-square" width="154" height="154" viewBox="0 0 154 154" fill="none">
                          <path d="M113.687 142.413C128.21 134.268 139.609 121.522 146.088 106.184C152.568 90.8463 153.759 73.7883 149.474 57.6986C145.19 41.6088 135.673 27.4024 122.423 17.3181C109.174 7.23391 92.9455 1.84535 76.2958 2.00171L76.507 24.5007C88.1619 24.3913 99.5217 28.1633 108.796 35.2222C118.071 42.2812 124.733 52.2257 127.732 63.4885C130.731 74.7513 129.897 86.692 125.362 97.4286C120.826 108.165 112.847 117.087 102.681 122.789L113.687 142.413Z" fill="#205EA3" stroke="white" strokeWidth="4"/>
                          <path d="M77.0232 1.9984C65.3273 1.99479 53.7926 4.72663 43.3407 9.97566C32.8888 15.2247 23.8094 22.8454 16.8278 32.2291C9.84619 41.6127 5.15596 52.4991 3.1318 64.0185C1.10764 75.538 1.80566 87.3712 5.17009 98.5727L26.7191 92.1004C24.364 84.2593 23.8754 75.9761 25.2923 67.9125C26.7092 59.8489 29.9924 52.2284 34.8795 45.6599C39.7666 39.0913 46.1222 33.7568 53.4385 30.0825C60.7549 26.4082 68.8291 24.4959 77.0163 24.4984L77.0232 1.9984Z" fill="#F7576C" stroke="white" strokeWidth="4"/>
                          <path d="M39.8147 11.8674C29.6575 17.6663 20.9974 25.7603 14.5261 35.5028C8.05476 45.2454 3.95169 56.3664 2.54465 67.9774C1.13761 79.5884 2.46561 91.3675 6.42254 102.374C10.3795 113.38 16.8557 123.308 25.3337 131.365L40.8336 115.056C34.899 109.416 30.3656 102.466 27.5958 94.7616C24.8259 87.0572 23.8963 78.8118 24.8812 70.6842C25.8662 62.5565 28.7383 54.7718 33.2682 47.952C37.7981 41.1322 43.8603 35.4664 50.9703 31.4072L39.8147 11.8674Z" fill="#E56C1D" stroke="white" strokeWidth="4"/>
                          <path d="M5.81601 100.619C9.60305 112.032 16.0791 122.368 24.6981 130.754C33.3171 139.14 43.8262 145.331 55.3393 148.804C66.8523 152.277 79.0318 152.931 90.8505 150.71C102.669 148.489 113.781 143.459 123.248 136.044L109.373 118.331C102.746 123.521 94.9684 127.042 86.6953 128.597C78.4222 130.152 69.8966 129.694 61.8375 127.263C53.7783 124.832 46.4219 120.498 40.3886 114.628C34.3554 108.758 29.8221 101.523 27.1712 93.5331L5.81601 100.619Z" fill="#009EAC" stroke="white" strokeWidth="4"/>
                        </svg>
                        <div className="flex flex-col justify-center items-start flex-1 self-stretch">
                          <div className="flex p-1 items-center gap-2 self-stretch">
                            <svg className="flex h-5 items-center gap-2.5" width="12" height="20" viewBox="0 0 12 20" fill="none">
                              <circle cx="6" cy="10" r="6" fill="#205EA3"></circle>
                            </svg>
                            <div className="flex justify-between items-center flex-1">
                              <span className="text-component-small font-medium text-mailchimp-text-primary leading-[140%] tracking-[-0.14px]">Female</span>
                              <div className="flex items-center gap-1.5">
                                <span className="text-component-small text-mailchimp-text-primary text-right leading-[140%]">58.3%</span>
                              </div>
                            </div>
                          </div>
                          <div className="flex p-1 items-center gap-2 self-stretch">
                            ...
                            <div className="flex justify-between items-center flex-1">
                              <span className="text-component-small font-medium text-mailchimp-text-primary leading-[140%] tracking-[-0.14px]">Male</span>
                              <div className="flex items-center gap-1.5">
                                <span className="text-component-small text-mailchimp-text-primary text-right leading-[140%]">14.8%</span>
                              </div>
                            </div>
                          </div>
                          <div className="flex p-1 items-center gap-2 self-stretch">
                            ...
                            <div className="flex justify-between items-center flex-1">
                              <span className="text-component-small font-medium text-mailchimp-text-primary leading-[140%] tracking-[-0.14px]">Another identity</span>
                              <div className="flex items-center gap-1.5">
                                <span className="text-component-small text-mailchimp-text-primary text-right leading-[140%]">6.3%</span>
                              </div>
                            </div>
                          </div>
                          <div className="flex p-1 items-center gap-2 self-stretch">
                            ...
                            <div className="flex justify-between items-center flex-1">
                              <span className="text-component-small font-medium text-mailchimp-text-primary leading-[140%] tracking-[-0.14px]">Unknown</span>
                              <div className="flex items-center gap-1.5">
                                <span className="text-component-small text-mailchimp-text-primary text-right leading-[140%]">20.6%</span>
                              </div>
                            </div>
                          </div>
                        </div>
                    ...
                    {/* Age Range Chart */}
                    <div className="flex flex-col items-start gap-2 flex-1">
                      <h3 className="text-component-small font-medium text-mailchimp-text-primary leading-[140%] tracking-[-0.14px] self-stretch">Age Range</h3>
                      <div className="flex items-center gap-4 self-stretch">
                        <img className="w-[150px] h-[150px] aspect-square" src="https://cdn.builder.io/api/v1/image/assets/TEMP/f8cc099edd11ee3c5977cf52a570b84796938f57" alt="donut chart" />
                        <div className="flex flex-col justify-center items-start flex-1 self-stretch">
                          <div className="flex p-1 items-center gap-2 self-stretch rounded bg-[#F8FAFB]">
                            ...
                            <div className="flex justify-between items-center flex-1">
                              <span className="text-component-small font-medium text-mailchimp-text-primary leading-[140%] tracking-[-0.14px]">18-24</span>
                              <div className="flex items-center gap-1.5">
                                <span className="text-component-small text-mailchimp-text-primary text-right leading-[140%]">26.9%</span>
                                <button className="flex p-1 justify-center items-center rounded-mailchimp bg-[#E2E9ED]">
                                  <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                                    <path d="M8.00008 9.33332C8.73646 9.33332 9.33341 8.73637 9.33341 7.99999C9.33341 7.26361 8.73646 6.66666 8.00008 6.66666C7.2637 6.66666 6.66675 7.26361 6.66675 7.99999C6.66675 8.73637 7.2637 9.33332 8.00008 9.33332Z" fill="#21262A"></path>
                                    <path d="M4.00008 9.33332C4.73646 9.33332 5.33341 8.73637 5.33341 7.99999C5.33341 7.26361 4.73646 6.66666 4.00008 6.66666C3.2637 6.66666 2.66675 7.26361 2.66675 7.99999C2.66675 8.73637 3.2637 9.33332 4.00008 9.33332Z" fill="#21262A"></path>
                                    <path d="M12.0001 9.33332C12.7365 9.33332 13.3334 8.73637 13.3334 7.99999C13.3334 7.26361 12.7365 6.66666 12.0001 6.66666C11.2637 6.66666 10.6667 7.26361 10.6667 7.99999C10.6667 8.73637 11.2637 9.33332 12.0001 9.33332Z" fill="#21262A"></path>
                                  </svg>
                                </button>
                              </div>
                            </div>
                          ...
                          <div className="flex p-1 items-center gap-2 self-stretch">
                            ...
                            <div className="flex justify-between items-center flex-1">
                              <span className="text-component-small font-medium text-mailchimp-text-primary leading-[140%] tracking-[-0.14px]">25-34</span>
                              <div className="flex items-center gap-1.5">
                                <span className="text-component-small text-mailchimp-text-primary text-right leading-[140%]">14.8%</span>
                              </div>
                            </div>
                          ...
                          <div className="flex p-1 items-center gap-2 self-stretch">
                            ...
                            <div className="flex justify-between items-center flex-1">
                              <span className="text-component-small font-medium text-mailchimp-text-primary leading-[140%] tracking-[-0.14px]">35-44</span>
                              <div className="flex items-center gap-1.5">
                                <span className="text-component-small text-mailchimp-text-primary text-right leading-[140%]">6.3%</span>
                              </div>
                            </div>
                          ...
                          <div className="flex p-1 items-center gap-2 self-stretch">
                            ...
                            <div className="flex justify-between items-center flex-1">
                              <span className="text-component-small font-medium text-mailchimp-text-primary leading-[140%] tracking-[-0.14px]">45-54</span>
                              <div className="flex items-center gap-1.5">
                                <span className="text-component-small text-mailchimp-text-primary text-right leading-[140%]">6.9%</span>
                              </div>
                            </div>
                          </div>
                          <div className="flex p-1 items-center gap-2 self-stretch">
                            <svg className="flex h-5 items-center gap-2.5" width="12" height="20" viewBox="0 0 12 20" fill="none">
                              <circle cx="6" cy="10" r="6" fill="#A275FF"></circle>
                            </svg>
                            <div className="flex justify-between items-center flex-1">
                              <span className="text-component-small font-medium text-mailchimp-text-primary leading-[140%] tracking-[-0.14px]">55-64</span>
                              <div className="flex items-center gap-1.5">
                                <span className="text-component-small text-mailchimp-text-primary text-right leading-[140%]">2.9%</span>
                              </div>
                            </div>
                          </div>
                          <div className="flex p-1 items-center gap-2 self-stretch">
                            <svg className="flex h-5 items-center gap-2.5" width="12" height="20" viewBox="0 0 12 20" fill="none">
                              <circle cx="6" cy="10" r="6" fill="#8F1229"></circle>
                            </svg>
                            <div className="flex justify-between items-center flex-1">
                              <span className="text-component-small font-medium text-mailchimp-text-primary leading-[140%] tracking-[-0.14px]">65+</span>
                              <div className="flex items-center gap-1.5">
                                <span className="text-component-small text-mailchimp-text-primary text-right leading-[140%]">10.7%</span>
                              </div>
                            </div>
                          </div>
                        </div>
              ...
              <div className="w-[402px] min-h-[140px] p-6 flex flex-col items-start gap-4 self-stretch rounded-mailchimp border border-mailchimp-border-primary bg-white">
                <div className="flex flex-col items-start gap-1 self-stretch">
                  ...
                  <div className="flex max-w-[600px] pr-15 justify-center items-center gap-2.5 self-stretch">
                    <p className="flex-1 text-[#4C555B] text-component-x-small font-normal leading-4">
                      Geolocation estimates where contacts are located, to target emails for specific regions or time zones.
                    </p>
                  </div>
                </div>
                  ...
                  <div className="flex py-[37px] px-0 items-center gap-4 self-stretch">
                    ...
                    <div className="flex flex-col justify-center items-start flex-1 self-stretch">
                      <div className="flex p-1 items-center gap-2 self-stretch">
                        ...
                        <div className="flex justify-between items-center flex-1">
                          <span className="text-component-small font-medium text-mailchimp-text-primary leading-[140%] tracking-[-0.14px]">United States</span>
                          <div className="flex items-center gap-1.5">
                            <span className="text-component-small text-mailchimp-text-primary text-right leading-[140%]">92.8%</span>
                          </div>
                        </div>
                      </div>
                      <div className="flex p-1 items-center gap-2 self-stretch">
                        ...
                        <div className="flex justify-between items-center flex-1">
                          <span className="text-component-small font-medium text-mailchimp-text-primary leading-[140%] tracking-[-0.14px]">Australia</span>
                          <div className="flex items-center gap-1.5">
                            <span className="text-component-small text-mailchimp-text-primary text-right leading-[140%]">1.6%</span>
                          </div>
                        </div>
                      </div>
                      <div className="flex p-1 items-center gap-2 self-stretch">
                        ...
                        <div className="flex justify-between items-center flex-1">
                          <span className="text-component-small font-medium text-mailchimp-text-primary leading-[140%] tracking-[-0.14px]">Singapore</span>
                          <div className="flex items-center gap-1.5">
                            <span className="text-component-small text-mailchimp-text-primary text-right leading-[140%]">1.8%</span>
                          </div>
                        </div>
                      </div>
                      <div className="flex p-1 items-center gap-2 self-stretch">
                        ...
                        <div className="flex justify-between items-center flex-1">
                          <span className="text-component-small font-medium text-mailchimp-text-primary leading-[140%] tracking-[-0.14px]">Other</span>
                          <div className="flex items-center gap-1.5">
                            <span className="text-component-small text-mailchimp-text-primary text-right leading-[140%]">3.8%</span>
                          </div>
                        </div>
                      </div>
                    </div>
                ...
                <div className="flex items-start gap-6 self-stretch">
                  ...
                  <div className="flex h-6 justify-end items-center gap-2">
                    <div className="flex items-start">
                      <div className="flex p-0.5 items-center gap-0.5 rounded-mailchimp bg-[#F0F4F6]">
                        <div className="flex min-w-12 px-2.5 py-0.5 justify-center items-center gap-1 rounded bg-white shadow-[0px_1px_4px_0px_rgba(76,85,91,0.2)]">
                          <span className="flex-1 text-mailchimp-text-primary text-center text-component-x-small font-normal leading-4">Counts</span>
                        </div>
                        <div className="flex min-w-12 px-2.5 py-0.5 justify-center items-center gap-1 rounded">
                          <span className="flex-1 text-[#727E85] text-center text-component-x-small font-normal leading-4">Percentages</span>
                        </div>
                      </div>
                    </div>
                    <button className="flex h-6 justify-end items-start">
              ...
              <div className="flex items-start self-stretch">
                ...
                <div className="flex flex-col items-start flex-1">
                  <div className="flex h-8 px-3 py-2 items-center self-stretch bg-[#F0F4F6]">
                    <div className="flex justify-center items-center">
                      <span className="text-[#727E85] text-component-x-small font-normal leading-4">Segment name</span>
                    </div>
                  </div>
                  <div className="flex h-[52px] px-3 py-2.5 items-center gap-0.5 self-stretch border-b border-mailchimp-border-primary bg-white">
                    <span className="flex-1 text-mailchimp-text-primary text-component-small font-medium leading-5 tracking-[-0.14px]">gmail.com</span>
                  </div>
                  <div className="flex h-[52px] px-3 py-2.5 items-center gap-0.5 self-stretch border-b border-mailchimp-border-primary bg-white">
                    <span className="flex-1 text-mailchimp-text-primary text-component-small font-medium leading-5 tracking-[-0.14px]">yahoo.com</span>
                  </div>
                  <div className="flex h-[52px] px-3 py-2.5 items-center gap-0.5 self-stretch border-b border-mailchimp-border-primary bg-[#F8FAFB]">
                    <div className="flex flex-col justify-center items-start gap-0.5 flex-1">
                      <span className="self-stretch text-mailchimp-text-primary text-component-small font-medium leading-5 tracking-[-0.14px]">outlook.com</span>
                    </div>
                  </div>
                  <div className="flex h-[52px] px-3 py-2.5 items-center gap-0.5 self-stretch bg-white">
                    <span className="flex-1 text-mailchimp-text-primary text-component-small font-medium leading-5 tracking-[-0.14px]">claycollective.com</span>
                  </div>
                </div>
                ...
                <div className="flex flex-col items-start flex-1">
                  <div className="flex h-8 px-3 py-2 justify-end items-center self-stretch bg-[#F0F4F6]">
                    <span className="text-[#727E85] text-component-x-small font-normal leading-[140%]">Deliveries</span>
                  </div>
                  <div className="flex h-[52px] px-3 py-2.5 justify-end items-center gap-0.5 self-stretch border-b border-mailchimp-border-primary bg-white">
                    <span className="text-mailchimp-text-primary text-right text-component-small font-normal leading-[140%]">18,103</span>
                  </div>
                  <div className="flex h-[52px] px-3 py-2.5 justify-end items-center gap-0.5 self-stretch border-b border-mailchimp-border-primary bg-white">
                    <span className="text-mailchimp-text-primary text-right text-component-small font-normal leading-[140%]">3,522</span>
                  </div>
                  <div className="flex h-[52px] px-3 py-2.5 justify-end items-center gap-0.5 self-stretch border-b border-mailchimp-border-primary bg-[#F8FAFB]">
                    <div className="flex flex-col justify-center items-end gap-0.5 flex-1">
                      <span className="self-stretch text-mailchimp-text-primary text-right text-component-small font-normal leading-5">1,729</span>
                    </div>
                  </div>
                  <div className="flex h-[52px] px-3 py-2.5 justify-end items-center gap-0.5 self-stretch bg-white">
                    <span className="text-mailchimp-text-primary text-right text-component-small font-normal leading-[140%]">3</span>
                  </div>
                </div>
                ...
                <div className="flex flex-col items-start flex-1">
                  <div className="flex h-8 px-3 py-2 justify-end items-center self-stretch bg-[#F0F4F6]">
                    <span className="text-[#727E85] text-component-x-small font-normal leading-[140%]">Unique opens</span>
                  </div>
                  <div className="flex h-[52px] px-3 py-2.5 justify-end items-center gap-0.5 self-stretch border-b border-mailchimp-border-primary bg-white">
                    <span className="text-mailchimp-text-primary text-right text-component-small font-normal leading-[140%]">3,780</span>
                  </div>
                  <div className="flex h-[52px] px-3 py-2.5 justify-end items-center gap-0.5 self-stretch border-b border-mailchimp-border-primary bg-white">
                    <span className="text-mailchimp-text-primary text-right text-component-small font-normal leading-[140%]">625</span>
                  </div>
                  <div className="flex h-[52px] px-3 py-2.5 justify-end items-center gap-0.5 self-stretch border-b border-mailchimp-border-primary bg-[#F8FAFB]">
                    <div className="flex flex-col justify-center items-end gap-0.5 flex-1">
                      <span className="self-stretch text-mailchimp-text-primary text-right text-component-small font-normal leading-5">326</span>
                    </div>
                  </div>
                  <div className="flex h-[52px] px-3 py-2.5 justify-end items-center gap-0.5 self-stretch bg-white">
                    <span className="text-mailchimp-text-primary text-right text-component-small font-normal leading-[140%]">3</span>
                ...
                <div className="flex flex-col items-start flex-1">
                  <div className="flex h-8 px-3 py-2 justify-end items-center self-stretch bg-[#F0F4F6]">
                    <span className="text-[#727E85] text-component-x-small font-normal leading-[140%]">Clicked</span>
                  </div>
                  <div className="flex h-[52px] px-3 py-2.5 justify-end items-center gap-0.5 self-stretch border-b border-mailchimp-border-primary bg-white">
                    <span className="text-mailchimp-text-primary text-right text-component-small font-normal leading-[140%]">431</span>
                  </div>
                  <div className="flex h-[52px] px-3 py-2.5 justify-end items-center gap-0.5 self-stretch border-b border-mailchimp-border-primary bg-white">
                    <span className="text-mailchimp-text-primary text-right text-component-small font-normal leading-[140%]">179</span>
                  </div>
                  <div className="flex h-[52px] px-3 py-2.5 justify-end items-center gap-0.5 self-stretch border-b border-mailchimp-border-primary bg-[#F8FAFB]">
                    <div className="flex flex-col justify-center items-end gap-0.5 flex-1">
                      <span className="self-stretch text-mailchimp-text-primary text-right text-component-small font-normal leading-5">51</span>
                    </div>
                  </div>
                  <div className="flex h-[52px] px-3 py-2.5 justify-end items-center gap-0.5 self-stretch bg-white">
                    <span className="text-mailchimp-text-primary text-right text-component-small font-normal leading-[140%]">3</span>
                ...
                <div className="flex flex-col items-start flex-1">
                  <div className="flex h-8 px-3 py-2 justify-end items-center self-stretch bg-[#F0F4F6]">
                    <span className="text-[#727E85] text-component-x-small font-normal leading-[140%]">Bounced</span>
                  </div>
                  <div className="flex h-[52px] px-3 py-2.5 justify-end items-center gap-0.5 self-stretch border-b border-mailchimp-border-primary bg-white">
                    <span className="text-mailchimp-text-primary text-right text-component-small font-normal leading-[140%]">97</span>
                  </div>
                  <div className="flex h-[52px] px-3 py-2.5 justify-end items-center gap-0.5 self-stretch border-b border-mailchimp-border-primary bg-white">
                    <span className="text-mailchimp-text-primary text-right text-component-small font-normal leading-[140%]">23</span>
                  </div>
                  <div className="flex h-[52px] px-3 py-2.5 justify-end items-center gap-0.5 self-stretch border-b border-mailchimp-border-primary bg-[#F8FAFB]">
                    <div className="flex flex-col justify-center items-end gap-0.5 flex-1">
                      <span className="self-stretch text-mailchimp-text-primary text-right text-component-small font-normal leading-5">11</span>
                    </div>
                  </div>
                  <div className="flex h-[52px] px-3 py-2.5 justify-end items-center gap-0.5 self-stretch bg-white">
                    <span className="text-mailchimp-text-primary text-right text-component-small font-normal leading-[140%]">0</span>
                  </div>
                </div>
                ...
                <div className="flex flex-col items-start flex-1">
                  <div className="flex h-8 px-3 py-2 justify-end items-center self-stretch bg-[#F0F4F6]">
                    <span className="text-[#727E85] text-component-x-small font-normal leading-[140%]">Unsubscribed</span>
                  </div>
                  <div className="flex h-[52px] px-3 py-2.5 justify-end items-center gap-0.5 self-stretch border-b border-mailchimp-border-primary bg-white">
                    <span className="text-mailchimp-text-primary text-right text-component-small font-normal leading-[140%]">462</span>
                  </div>
                  <div className="flex h-[52px] px-3 py-2.5 justify-end items-center gap-0.5 self-stretch border-b border-mailchimp-border-primary bg-white">
                    <span className="text-mailchimp-text-primary text-right text-component-small font-normal leading-[140%]">60</span>
                  </div>
                  <div className="flex h-[52px] px-3 py-2.5 justify-end items-center gap-0.5 self-stretch border-b border-mailchimp-border-primary bg-[#F8FAFB]">
                    <div className="flex flex-col justify-center items-end gap-0.5 flex-1">
                      <span className="self-stretch text-mailchimp-text-primary text-right text-component-small font-normal leading-5">20</span>
                    </div>
                  </div>
                  <div className="flex h-[52px] px-3 py-2.5 justify-end items-center gap-0.5 self-stretch bg-white">
                    <span className="text-mailchimp-text-primary text-right text-component-small font-normal leading-[140%]">0</span>
                ...
                <div className="flex flex-col items-start flex-1">
                  ...
                  <div className="flex h-[52px] px-3 py-2.5 justify-end items-center self-stretch border-b border-mailchimp-border-primary bg-white">
                  </div>
                  <div className="flex h-[52px] px-3 py-2.5 justify-end items-center self-stretch border-b border-mailchimp-border-primary bg-white">
                  </div>
                  <div className="flex h-[52px] px-3 py-2.5 justify-end items-center self-stretch border-b border-mailchimp-border-primary bg-[#F8FAFB]">
                    <div className="flex items-center gap-[-1px]">
                      <button className="flex min-w-12 px-2.5 py-1 justify-center items-center gap-2.5 rounded-l-mailchimp border border-[#D5DEE3] bg-white">
                        <span className="text-mailchimp-text-primary text-component-x-small font-normal leading-4">View insights</span>
                      </button>
                      <button className="flex px-1 py-1 justify-center items-center gap-2.5 rounded-r-mailchimp border border-[#D5DEE3] bg-white">
                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                          <path d="M8.0096 10.6786C7.9219 10.6786 7.83506 10.6613 7.75407 10.6277C7.67307 10.594 7.59951 10.5448 7.5376 10.4826L3.54293 6.47665C3.48099 6.41466 3.43186 6.34109 3.39836 6.26012C3.36485 6.17915 3.34763 6.09237 3.34766 6.00475C3.34769 5.91712 3.36498 5.83035 3.39854 5.74941C3.4321 5.66846 3.48128 5.59492 3.54326 5.53298C3.60525 5.47104 3.67882 5.42192 3.75979 5.38841C3.84076 5.35491 3.92754 5.33768 4.01517 5.33771C4.10279 5.33774 4.18956 5.35503 4.2705 5.38859C4.35145 5.42215 4.42499 5.47133 4.48693 5.53331L8.01093 9.06665L11.5443 5.54331C11.6694 5.4184 11.8391 5.34833 12.016 5.34851C12.1928 5.3487 12.3623 5.41913 12.4873 5.54431C12.6122 5.6695 12.6823 5.83917 12.6821 6.01602C12.6819 6.19287 12.6114 6.3624 12.4863 6.48731L8.48026 10.484C8.35532 10.6086 8.18607 10.6786 8.0096 10.6786Z" fill="#21262A"></path>
                        </svg>
                      </button>
                    </div>
                  </div>
                  <div className="flex h-[52px] px-3 py-2.5 justify-end items-center self-stretch bg-white">
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="flex w-full h-[321px] p-6 flex-col items-start gap-4 rounded-mailchimp border border-mailchimp-border-primary bg-white">
                ...
                <div className="flex items-start gap-6 self-stretch">
                  ...
                  <div className="flex h-6 justify-end items-center gap-2">
                    <div className="flex items-start">
                      <div className="flex p-0.5 items-center gap-0.5 rounded-mailchimp bg-[#F0F4F6]">
                        <div className="flex min-w-12 px-2.5 py-0.5 justify-center items-center gap-1 rounded bg-white shadow-[0px_1px_4px_0px_rgba(76,85,91,0.2)]">
                          <span className="flex-1 text-mailchimp-text-primary text-center text-component-x-small font-normal leading-4">Segments</span>
                        </div>
                        <div className="flex min-w-12 px-2.5 py-0.5 justify-center items-center gap-1 rounded">
                          <span className="flex-1 text-[#727E85] text-center text-component-x-small font-normal leading-4">Tags</span>
                        </div>
                        <div className="flex min-w-12 px-2.5 py-0.5 justify-center items-center gap-1 rounded">
                          <span className="flex-1 text-[#727E85] text-center text-component-x-small font-normal leading-4">Groups</span>
                        </div>
                      </div>
                    </div>
                    <div className="flex items-start">
              ...
              <div className="flex items-start self-stretch">
                ...
                <div className="flex flex-col items-start flex-1">
                  ...
                  <div className="flex h-[52px] px-3 py-2.5 items-center gap-0.5 self-stretch border-b border-mailchimp-border-primary bg-white">
                    <span className="flex-1 text-mailchimp-text-primary text-component-small font-medium leading-5 tracking-[-0.14px]">New subscribers</span>
                  </div>
                  <div className="flex h-[52px] px-3 py-2.5 items-center gap-0.5 self-stretch border-b border-mailchimp-border-primary bg-white">
                    <span className="flex-1 text-mailchimp-text-primary text-component-small font-medium leading-5 tracking-[-0.14px]">Previous buyers</span>
                  </div>
                  <div className="flex h-[52px] px-3 py-2.5 items-center gap-0.5 self-stretch border-b border-mailchimp-border-primary bg-white">
                    <span className="flex-1 text-mailchimp-text-primary text-component-small font-medium leading-5 tracking-[-0.14px]">High spenders</span>
                  </div>
                  <div className="flex h-[52px] px-3 py-2.5 items-center gap-0.5 self-stretch bg-white">
                    <span className="flex-1 text-mailchimp-text-primary text-component-small font-medium leading-5 tracking-[-0.14px]">Students</span>
                  </div>
                </div>
                ...
                <div className="flex flex-col items-start flex-1">
                  ...
                  <div className="flex h-[52px] px-3 py-2.5 justify-end items-center gap-0.5 self-stretch border-b border-mailchimp-border-primary bg-white">
                    <span className="text-mailchimp-text-primary text-right text-component-small font-normal leading-[140%]">7,203</span>
                  </div>
                  <div className="flex h-[52px] px-3 py-2.5 justify-end items-center gap-0.5 self-stretch border-b border-mailchimp-border-primary bg-white">
                    <span className="text-mailchimp-text-primary text-right text-component-small font-normal leading-[140%]">11,119</span>
                  </div>
                  <div className="flex h-[52px] px-3 py-2.5 justify-end items-center gap-0.5 self-stretch border-b border-mailchimp-border-primary bg-white">
                    <span className="text-mailchimp-text-primary text-right text-component-small font-normal leading-[140%]">4,492</span>
                  </div>
                  <div className="flex h-[52px] px-3 py-2.5 justify-end items-center gap-0.5 self-stretch bg-white">
                    <span className="text-mailchimp-text-primary text-right text-component-small font-normal leading-[140%]">2,842</span>
                  </div>
                </div>
                ...
                <div className="flex flex-col items-start flex-1">
                  ...
                  <div className="flex h-[52px] px-3 py-2.5 justify-end items-center gap-0.5 self-stretch border-b border-mailchimp-border-primary bg-white">
                    <span className="text-mailchimp-text-primary text-right text-component-small font-normal leading-[140%]">1,454</span>
                  </div>
                  <div className="flex h-[52px] px-3 py-2.5 justify-end items-center gap-0.5 self-stretch border-b border-mailchimp-border-primary bg-white">
                    <span className="text-mailchimp-text-primary text-right text-component-small font-normal leading-[140%]">2,423</span>
                  </div>
                  <div className="flex h-[52px] px-3 py-2.5 justify-end items-center gap-0.5 self-stretch border-b border-mailchimp-border-primary bg-white">
                    <span className="text-mailchimp-text-primary text-right text-component-small font-normal leading-[140%]">933</span>
                  </div>
                  <div className="flex h-[52px] px-3 py-2.5 justify-end items-center gap-0.5 self-stretch bg-white">
                    <span className="text-mailchimp-text-primary text-right text-component-small font-normal leading-[140%]">434</span>
                  </div>
                </div>
                ...
                <div className="flex flex-col items-start flex-1">
                  ...
                  <div className="flex h-[52px] px-3 py-2.5 justify-end items-center gap-0.5 self-stretch border-b border-mailchimp-border-primary bg-white">
                    <span className="text-mailchimp-text-primary text-right text-component-small font-normal leading-[140%]">265</span>
                  </div>
                  <div className="flex h-[52px] px-3 py-2.5 justify-end items-center gap-0.5 self-stretch border-b border-mailchimp-border-primary bg-white">
                    <span className="text-mailchimp-text-primary text-right text-component-small font-normal leading-[140%]">429</span>
                  </div>
                  <div className="flex h-[52px] px-3 py-2.5 justify-end items-center gap-0.5 self-stretch border-b border-mailchimp-border-primary bg-white">
                    <span className="text-mailchimp-text-primary text-right text-component-small font-normal leading-[140%]">192</span>
                  </div>
                  <div className="flex h-[52px] px-3 py-2.5 justify-end items-center gap-0.5 self-stretch bg-white">
                    <span className="text-mailchimp-text-primary text-right text-component-small font-normal leading-[140%]">105</span>
                  </div>
                </div>
                ...
                <div className="flex flex-col items-start flex-1">
                  ...
                  <div className="flex h-[52px] px-3 py-2.5 justify-end items-center gap-0.5 self-stretch border-b border-mailchimp-border-primary bg-white">
                    <span className="text-mailchimp-text-primary text-right text-component-small font-normal leading-[140%]">82</span>
                  </div>
                  <div className="flex h-[52px] px-3 py-2.5 justify-end items-center gap-0.5 self-stretch border-b border-mailchimp-border-primary bg-white">
                    <span className="text-mailchimp-text-primary text-right text-component-small font-normal leading-[140%]">2</span>
                  </div>
                  <div className="flex h-[52px] px-3 py-2.5 justify-end items-center gap-0.5 self-stretch border-b border-mailchimp-border-primary bg-white">
                    <span className="text-mailchimp-text-primary text-right text-component-small font-normal leading-[140%]">7</span>
                  </div>
                  <div className="flex h-[52px] px-3 py-2.5 justify-end items-center gap-0.5 self-stretch bg-white">
                    <span className="text-mailchimp-text-primary text-right text-component-small font-normal leading-[140%]">19</span>
                  </div>
                </div>
                ...
                <div className="flex flex-col items-start flex-1">
                  ...
                  <div className="flex h-[52px] px-3 py-2.5 justify-end items-center gap-0.5 self-stretch border-b border-mailchimp-border-primary bg-white">
                    <span className="text-mailchimp-text-primary text-right text-component-small font-normal leading-[140%]">12</span>
                  </div>
                  <div className="flex h-[52px] px-3 py-2.5 justify-end items-center gap-0.5 self-stretch border-b border-mailchimp-border-primary bg-white">
                    <span className="text-mailchimp-text-primary text-right text-component-small font-normal leading-[140%]">37</span>
                  </div>
                  <div className="flex h-[52px] px-3 py-2.5 justify-end items-center gap-0.5 self-stretch border-b border-mailchimp-border-primary bg-white">
                    <span className="text-mailchimp-text-primary text-right text-component-small font-normal leading-[140%]">10</span>
                  </div>
                  <div className="flex h-[52px] px-3 py-2.5 justify-end items-center gap-0.5 self-stretch bg-white">
                    <span className="text-mailchimp-text-primary text-right text-component-small font-normal leading-[140%]">2</span>
                  </div>
