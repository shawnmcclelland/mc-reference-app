    ...
    <div className="flex h-[844px] p-8 pt-5 flex-col items-start gap-6 self-stretch rounded-mailchimp-lg rounded-b-none border border-mailchimp-border-primary bg-white">
      ...
      <div className="flex justify-between items-center self-stretch">
        ...
        <div className="flex items-center gap-2">
          <div className="color-[#21262A] font-['Graphik_Mailchimp'] text-[24px] font-medium leading-[120%] tracking-[-0.48px]">
            Contacts
          </div>
        </div>
        ...
        <div className="flex items-end gap-2 self-stretch">
          {/* Date range select */}
          <div className="flex min-h-8 flex-col justify-center items-end gap-1 rounded-[6px]">
            <button className="flex min-w-16 px-3 py-1.5 justify-center items-center gap-1 rounded-[6px] border border-[#D5DEE3] bg-white">
              <span className="color-[#21262A] font-['Graphik_Mailchimp'] text-sm font-normal leading-5">
                All time
              </span>
          ...
          {/* Icon Button - Email with Badge */}
          <div className="flex items-start">
            <button className="relative flex p-1.5 justify-center items-center rounded-[6px] border border-[#D5DEE3] bg-white">
              ...
              <div className="absolute -top-1.5 -right-1.5 flex min-w-4 min-h-4 flex-col justify-center items-center gap-2 rounded-full bg-[#5D686F]">
                <span className="color-white text-center font-['Graphik_Mailchimp'] text-[9px] font-medium leading-[10px]">
                  3
                </span>
              </div>
            </button>
          ...
          <div className="flex flex-col items-start">
            <button className="flex p-1.5 justify-center items-center rounded-[6px] border border-[#D5DEE3] bg-white">
              <div className="flex w-5 h-5 justify-center items-center">
                <svg
                  width="20"
                  height="20"
          ...
          <div className="flex items-start">
            <div className="flex flex-col items-start gap-1">
              <div className="flex w-[200px] px-2.5 py-2 items-center gap-1 rounded-[6px] border border-[#C3CED5] bg-white">
                <div className="flex-1 color-[#21262A] font-['Graphik_Mailchimp'] text-xs font-normal leading-4 tracking-[-0.12px]">
                  Audience Clay Collective
                </div>
                <div className="flex w-4 h-4 justify-center items-center flex-shrink-0">
                  <svg
                    width="16"
                    height="16"
                    viewBox="0 0 16 16"
                  ...
                  >
                    <path
                      d="M8.00911 10.6787C7.92141 10.6787 7.83457 10.6614 7.75358 10.6277C7.67259 10.5941 7.59902 10.5448 7.53711 10.4827L3.54244 6.47671C3.4805 6.41472 3.43138 6.34115 3.39787 6.26018C3.36437 6.17921 3.34714 6.09243 3.34717 6.00481C3.3472 5.91718 3.36449 5.83042 3.39805 5.74947C3.43161 5.66852 3.48079 5.59498 3.54277 5.53304C3.60476 5.4711 3.67834 5.42198 3.7593 5.38847C3.84027 5.35497 3.92705 5.33774 4.01468 5.33777C4.1023 5.3378 4.18907 5.35509 4.27001 5.38865C4.35096 5.42221 4.4245 5.47139 4.48644 5.53338L8.01044 9.06671L11.5438 5.54338C11.669 5.41846 11.8386 5.34839 12.0155 5.34857C12.1923 5.34876 12.3619 5.41919 12.4868 5.54438C12.6117 5.66956 12.6818 5.83924 12.6816 6.01608C12.6814 6.19293 12.611 6.36246 12.4858 6.48738L8.47977 10.484C8.35483 10.6087 8.18558 10.6787 8.00911 10.6787Z"
                      fill="#21262A"
                    />
                  </svg>
                </div>
          ...
          {/* Primary Action - Add contacts */}
          <div className="flex items-start">
            <button className="flex min-w-16 px-3 py-1.5 justify-center items-center gap-1 rounded-[6px] bg-[#017E89]">
              <span className="color-white font-['Graphik_Mailchimp'] text-sm font-normal leading-5">
                Add contacts
              </span>
              <div className="flex items-center gap-2">
                <div className="flex w-4 h-4 justify-center items-center">
      ...
      <div className="flex w-[1256px] p-2 flex-col items-start gap-2 rounded-mailchimp border border-mailchimp-border-primary bg-white">
        {/* Settings row */}
        <div className="flex justify-end items-center gap-1.5 relative -top-2 -right-2">
          <Button
            variant="outline"
            size="sm"
            className="flex p-1 justify-center items-center rounded-mailchimp border border-mailchimp-border-secondary bg-white"
          >
            <svg
              width="16"
              height="16"
          ...
          <Button
            variant="outline"
            size="sm"
            className="flex min-w-12 px-2.5 py-1 justify-center items-center gap-1 rounded-mailchimp border border-mailchimp-border-secondary bg-white text-mailchimp-text-primary text-xs font-normal leading-4"
          >
            Analytics
          </Button>
        </div>
