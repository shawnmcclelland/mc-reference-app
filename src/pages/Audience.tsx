...
export default function Audience() {
  return (
    <div className="flex h-[844px] w-[1560px] max-w-[1560px] p-8 pt-5 flex-col items-start gap-6 self-stretch rounded-mailchimp-lg rounded-b-none border border-mailchimp-border-primary bg-white">
      {/* Page Header */}
        ...
        <div className="flex items-end gap-2 self-stretch">
          ...
          <div className="flex items-start">
            <Button
              variant="outline"
              size="icon"
              className="relative flex h-8 w-8 p-1.5 justify-center items-center rounded-mailchimp border border-mailchimp-border-secondary bg-white"
            >
              <svg
                width="20"
                height="20"
