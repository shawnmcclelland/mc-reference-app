    ...
    <div className="flex h-[844px] p-8 pt-5 flex-col items-start gap-6 self-stretch rounded-mailchimp-lg rounded-b-none border border-mailchimp-border-primary bg-white">
      ...
      <div className="flex justify-between items-center self-stretch">
        <div className="flex items-center gap-2">
          <div className="text-mailchimp-text-primary font-medium text-2xl leading-[120%] tracking-[-0.48px]">
            Contacts
          </div>
        </div>
        <div className="flex items-end gap-2 self-stretch">
          ...
          <div className="flex min-h-8 flex-col justify-center items-end gap-1 rounded-mailchimp">
            <Button
              variant="outline"
              className="flex min-w-16 px-3 py-1.5 justify-center items-center gap-1 rounded-mailchimp border border-mailchimp-border-secondary bg-white text-mailchimp-text-primary text-sm font-normal leading-5"
            >
              <span>All time</span>
              <CalendarIcon />
            </Button>
          ...
          <div className="flex items-start gap-2">
            ...
            <Button
              variant="outline"
              className="relative flex p-1.5 justify-center items-center rounded-mailchimp border border-mailchimp-border-secondary bg-white"
            >
              <svg
                width="20"
                height="20"
              ...
              <div className="absolute -top-1.5 -right-1.5 flex min-w-4 min-h-4 flex-col justify-center items-center gap-2 rounded-full bg-[#5D686F]">
                <span className="text-white text-center font-medium text-[9px] leading-[10px]">
                  3
                </span>
              </div>
            </Button>
            ...
            {/* Audience select */}
            <Select>
              <SelectTrigger className="flex w-[200px] px-2 py-2 items-center gap-1 rounded-mailchimp border border-mailchimp-input-border bg-white text-mailchimp-text-primary text-xs font-normal leading-4 tracking-[-0.12px]">
            ...
            {/* Add contacts button */}
            <Button className="flex min-w-16 px-3 py-1.5 justify-center items-center gap-1 rounded-mailchimp bg-[#017E89] text-white text-sm font-normal leading-5">
