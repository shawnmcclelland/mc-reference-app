...
export default function Audience() {
  return (
    <div className="flex h-[844px] w-[1560px] max-w-[1560px] p-8 pt-5 flex-col items-start gap-6 self-stretch rounded-mailchimp-lg rounded-b-none border border-mailchimp-border-primary bg-white">
      ...
      {/* Data Well */}
      <div className="flex w-[1256px] p-2 flex-col items-start gap-2 rounded-mailchimp border border-mailchimp-border-primary bg-white relative">
        {/* Actions */}
        <div className="flex justify-end items-center gap-1.5 relative translate-x-2 translate-y-2">
          {/* Settings */}
